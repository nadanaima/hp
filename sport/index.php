						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Dakhla agadir</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+212645789123</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>sport@gmail.com</a></li>
								</ul>
							</div>
						</div>
				...
				<div class="container">
					<div class="row" >
						<div class="col-md-12 text-center" >
							...
							<centre>	Copyright &copy;2020 All rights reserved by sport</CENTRE>
							</span>
						</div>
					</div>
				</div>
